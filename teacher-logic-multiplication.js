...
document.addEventListener("DOMContentLoaded", function () { 
  ...
  solveButton.addEventListener("click", function () {
    ...
    const bValue = parseFloat(document.getElementById("input2").value);
    ...
    if (isNaN(aValue) || isNaN(bValue)) {
      ...
      solutionParagraph.textContent = "please enter valid 2 valid numbers";} 
      else {  // output the answer if all values are numbers 
        let xValue; // define xValue
          xValue = aValue * bValue; //work out answer
