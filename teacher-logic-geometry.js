...
function getMousePos(e) {
  ...
  ////////////////////////////////////////////////// GEOMETRY TEACHER TEST CODE BELOW
...
document.addEventListener("DOMContentLoaded", function () { 
  ...
  solveButton.addEventListener("click", function () {
    ...
    const aValue = parseFloat(document.getElementById("shortSide1Input").value);
    const bValue = parseFloat(document.getElementById("shortSide2Input").value);
    ...
    if (isNaN(aValue) || isNaN(bValue)) {
      ...
      solutionParagraph.textContent = "please enter valid numbers for the two short sides";} 
      else {  // output the answer if all values are numbers 
        let xValue; // define xValue
          xValue = Math.sqrt(aValue ** 2 + bValue ** 2); //work out answer
